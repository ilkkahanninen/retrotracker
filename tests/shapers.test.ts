...
import { applyShaper, SHAPER_MODES, type ShaperMode } from '../src/core/audio/shapers';

const NON_BYPASS: readonly Exclude<ShaperMode, 'none'>[] = SHAPER_MODES
  .filter((m): m is Exclude<ShaperMode, 'none'> => m !== 'none');
