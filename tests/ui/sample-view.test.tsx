...
describe("view switching", () => {
  it("starts in the pattern view by default", () => {
    ...
    expect(
      container.querySelector(".sampleview-wrapper.view-hidden"),
    ).not.toBeNull();
  });
  ...
  it("clicking the Sample tab switches to the sample editor and hides the order pane", async () => {
    ...
    await user.click(
      container.querySelectorAll<HTMLButtonElement>(".viewtabs button")[1]!,
    );
