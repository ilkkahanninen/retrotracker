...
export const PERIOD_TABLE: readonly (readonly number[])[] = [
  ...
  [
    ...
    352, 332, 314, 296, 280, 264, 249, 235, 222, 209, 198, 187, 176, 166, 158,
  ...
  [
    ...
    342, 323, 305, 288, 272, 256, 242, 228, 216, 203, 192, 181, 171, 161, 152,
  ...
  [
    ...
    379, 357, 338, 318, 300, 284, 268, 253, 238, 225, 212, 200, 189, 179, 169,
  ...
  // finetune -5 (11)
  [
    887, 838, 791, 746, 704, 665, 628, 593, 559, 528, 498, 470, 444, 419, 395,
